...
public class CaptureQualityController implements SeekBar.OnSeekBarChangeListener {
  ...
  private BaseFragment.OnFragmentEvents fragmentEvents;
  private int width = 0;
  ...
  public CaptureQualityController(
          TextView captureFormatText, BaseFragment.OnFragmentEvents fragmentEvents) {
  ...
  public void onStopTrackingTouch(SeekBar seekBar) {
      fragmentEvents.onCaptureFormatChange(width, height, framerate);
  }
